...
#### [6.1.1](https://github.com/Probable-Futures/apps/compare/6.1.0...6.1.1)

- sc-5977: bug PF Pro crashes when specific map is selected [sc-5977] [`#1685`](https://github.com/Probable-Futures/apps/pull/1685)
- feat(maps): support map version comparison [`#1683`](https://github.com/Probable-Futures/apps/pull/1683)
- fix(api): notify Slack only after the feedback write succeeds [`#1682`](https://github.com/Probable-Futures/apps/pull/1682)
- fix: initial startup db and seeding bugs [`#1681`](https://github.com/Probable-Futures/apps/pull/1681)
- fix(api): send notification when 90requests per min are hit [`#1676`](https://github.com/Probable-Futures/apps/pull/1676)
- fix(maps): stop "Select a map" title re-animating on every toggle [`#1672`](https://github.com/Probable-Futures/apps/pull/1672)
- fix(pro): duplicated data points after uploading a file [`#1666`](https://github.com/Probable-Futures/apps/pull/1666)
- Release 6.1.0 [`48f0ba8`](https://github.com/Probable-Futures/apps/commit/48f0ba8acaa0e7affaa276cd7a8dcc638f018ebd)
- bot(feat): update submodules [`476441b`](https://github.com/Probable-Futures/apps/commit/476441be5803deb69740cd7780cfeaead9d8c0ef)

#### [6.1.0](https://github.com/Probable-Futures/apps/compare/6.0.0...6.1.0)

> 19 June 2026

- feat(maps): make dynamic low/mid percentile labels/icons [`#1664`](https://github.com/Probable-Futures/apps/pull/1664)
- sc-5959: generate a report on our data users [`#1659`](https://github.com/Probable-Futures/apps/pull/1659)
- feat: users must set their own mapbox tokens when using our libs [`#1660`](https://github.com/Probable-Futures/apps/pull/1660)
- feat: show average/median year in key [`#1658`](https://github.com/Probable-Futures/apps/pull/1658)
- feat(maps): introduce pending state for degrees buttons in compare mode [`#1657`](https://github.com/Probable-Futures/apps/pull/1657)
- fix(pro): link share bugs [sc-5956] [`#1655`](https://github.com/Probable-Futures/apps/pull/1655)
- fix(maps): compare maps incosistent zoom [`#1654`](https://github.com/Probable-Futures/apps/pull/1654)
- fix(maps): zoom in compare maps [`#1653`](https://github.com/Probable-Futures/apps/pull/1653)
- feat(maps): implement comparison maps [`#1651`](https://github.com/Probable-Futures/apps/pull/1651)
- feat: percentile view enhancemets [`#1652`](https://github.com/Probable-Futures/apps/pull/1652)
- feat(maps): support wamrer and cooler percentiles [`#1650`](https://github.com/Probable-Futures/apps/pull/1650)
- feat: support mean and median values when importing datasets [`#1649`](https://github.com/Probable-Futures/apps/pull/1649)
- feat: improve popup behavior in embeddable maps [`#1642`](https://github.com/Probable-Futures/apps/pull/1642)
- feat(maps): introduce vitest [`#1641`](https://github.com/Probable-Futures/apps/pull/1641)
- feat(api): add ai_name column to the adaptation_case_studies table [`#1640`](https://github.com/Probable-Futures/apps/pull/1640)
- feat(api): implement unit tests [`#1638`](https://github.com/Probable-Futures/apps/pull/1638)
- sc-5942(pro): change map click behavior in pf pro [`#1637`](https://github.com/Probable-Futures/apps/pull/1637)
- chore: bump vite and uuid deps [`#1636`](https://github.com/Probable-Futures/apps/pull/1636)
- fix(worker): missing rows in processed file [`#1635`](https://github.com/Probable-Futures/apps/pull/1635)
- fix(geocode): include state in mapbox query to disambiguate cities [`#1631`](https://github.com/Probable-Futures/apps/pull/1631)
- fix(pro): repair responsive layout on tablet / narrow laptop [`#1633`](https://github.com/Probable-Futures/apps/pull/1633)
- feat(db): support knowledge schema extraction layer [`#1630`](https://github.com/Probable-Futures/apps/pull/1630)
- fix: use react components for icons [`#1627`](https://github.com/Probable-Futures/apps/pull/1627)
- chore: maps rollup output config [`#1626`](https://github.com/Probable-Futures/apps/pull/1626)
- chore: use vite instead of react-scripts [`#1618`](https://github.com/Probable-Futures/apps/pull/1618)
- chore: update node and project dependencies [`#1614`](https://github.com/Probable-Futures/apps/pull/1614)
- fix: add tracking middlware to cors [`#1611`](https://github.com/Probable-Futures/apps/pull/1611)
- sc-5925: set up backend for was this helpful module [`#1610`](https://github.com/Probable-Futures/apps/pull/1610)
- fix: stop disabling swap [`#1609`](https://github.com/Probable-Futures/apps/pull/1609)
- chore(deps): bump flatted from 3.4.1 to 3.4.2 [`#1608`](https://github.com/Probable-Futures/apps/pull/1608)
- feat(db): preserve adaptation session data [`#1607`](https://github.com/Probable-Futures/apps/pull/1607)
- chore(deps): bump flatted from 3.2.9 to 3.4.1 [`#1605`](https://github.com/Probable-Futures/apps/pull/1605)
- Chore rename map clicked mixpanel event [`#1606`](https://github.com/Probable-Futures/apps/pull/1606)
- fix: use the correct function from the ui state [`#1604`](https://github.com/Probable-Futures/apps/pull/1604)
- refactor: pf pro enhancements [`#1603`](https://github.com/Probable-Futures/apps/pull/1603)
- fix(pro): country borders [`#1602`](https://github.com/Probable-Futures/apps/pull/1602)
- sc-5917: update Pro toolbar to match public maps [`#1601`](https://github.com/Probable-Futures/apps/pull/1601)
- Fix infinite loop crash on maps page caused by duplicate hashchange listeners [`#1600`](https://github.com/Probable-Futures/apps/pull/1600)
- chore: upgrate pulumi actions to v6 [`#1599`](https://github.com/Probable-Futures/apps/pull/1599)
- sc-5913: add location search to PF Pro [`#1597`](https://github.com/Probable-Futures/apps/pull/1597)
- sc-5915: closing Create Project modal results in white screen [`#1596`](https://github.com/Probable-Futures/apps/pull/1596)
- Feat mixpanel tracking [`#1590`](https://github.com/Probable-Futures/apps/pull/1590)
- fix(ci/cd): move the migration step outside the matrix [`#1595`](https://github.com/Probable-Futures/apps/pull/1595)
- feat: add a script for usage stats [`#1593`](https://github.com/Probable-Futures/apps/pull/1593)
- chore(deps): bump bn.js from 4.12.0 to 4.12.3 [`#1588`](https://github.com/Probable-Futures/apps/pull/1588)
- chore(deps): bump basic-ftp from 5.0.4 to 5.2.0 [`#1589`](https://github.com/Probable-Futures/apps/pull/1589)
- chore(deps-dev): bump rollup from 4.50.1 to 4.59.0 [`#1594`](https://github.com/Probable-Futures/apps/pull/1594)
- feat(pro): enhance the user requests screen [`#1592`](https://github.com/Probable-Futures/apps/pull/1592)
- feat: enhance error handling in user access requests [`#1591`](https://github.com/Probable-Futures/apps/pull/1591)
- fix: ajv lib after upgrade [`#1587`](https://github.com/Probable-Futures/apps/pull/1587)
- feat(db): adaptation content and embeddings [`#1585`](https://github.com/Probable-Futures/apps/pull/1585)
- chore(deps): bump ajv from 6.12.6 to 8.18.0 [`#1586`](https://github.com/Probable-Futures/apps/pull/1586)
- chore(deps): bump webpack from 5.101.3 to 5.105.0 [`#1581`](https://github.com/Probable-Futures/apps/pull/1581)
- chore(deps): bump jsonpath from 1.1.1 to 1.2.1 [`#1583`](https://github.com/Probable-Futures/apps/pull/1583)
- chore(deps): bump ajv from 6.12.6 to 8.18.0 [`#1584`](https://github.com/Probable-Futures/apps/pull/1584)
- feat: enhance deleteInactiveAuth0Clients script and add some todos [`#1582`](https://github.com/Probable-Futures/apps/pull/1582)
- feat: retire storybook [`#1580`](https://github.com/Probable-Futures/apps/pull/1580)
- chore: rebuild deployment into a matrix [`#1578`](https://github.com/Probable-Futures/apps/pull/1578)
- fix: eslint failing in maps [`#1576`](https://github.com/Probable-Futures/apps/pull/1576)
- chore: update how we manage repo access to each other [`#1574`](https://github.com/Probable-Futures/apps/pull/1574)
- chore: allow manual trigger of the syncing workflow [`#1575`](https://github.com/Probable-Futures/apps/pull/1575)
- docs: add getting started doc [`#1573`](https://github.com/Probable-Futures/apps/pull/1573)
- chore: bump diff and loadash-es [`#1572`](https://github.com/Probable-Futures/apps/pull/1572)
- update lock file [`#1570`](https://github.com/Probable-Futures/apps/pull/1570)
- build(deps-dev): bump eslint from 8.56.0 to 9.26.0 [`#1571`](https://github.com/Probable-Futures/apps/pull/1571)
- feat: implement raw data api [`#1565`](https://github.com/Probable-Futures/apps/pull/1565)
- build(deps-dev): bump storybook from 7.6.15 to 7.6.21 [`#1566`](https://github.com/Probable-Futures/apps/pull/1566)
- fix: circular dependencies during build [`#1567`](https://github.com/Probable-Futures/apps/pull/1567)
- Release 6.1.0 [`f4f8aad`](https://github.com/Probable-Futures/apps/commit/f4f8aad546dcb103ca09eb09a71cd589b8b8248f)
- bot(feat): update submodules [`1c00bf5`](https://github.com/Probable-Futures/apps/commit/1c00bf5a4c7dd59d612f9d0fd563fb4da2f7ab8e)
- bot(feat): update submodules [`038a9da`](https://github.com/Probable-Futures/apps/commit/038a9daf92b5bf063aba648ffd6f2a2b4e7edbd6)

### [6.0.0](https://github.com/Probable-Futures/apps/compare/5.0.0...6.0.0)

> 16 December 2025

- Hotfix pf pro map styles [`#1561`](https://github.com/Probable-Futures/apps/pull/1561)
- hotfix: Close side panel during map screenshots [`#1562`](https://github.com/Probable-Futures/apps/pull/1562)
- Update: Pro documentation page to home [`#1563`](https://github.com/Probable-Futures/apps/pull/1563)
- build(deps): bump jws from 3.2.2 to 3.2.3 [`#1556`](https://github.com/Probable-Futures/apps/pull/1556)
- hotfix: Stop layer clicks firing when the map is dragged [`#1549`](https://github.com/Probable-Futures/apps/pull/1549)
- feat: Ensure about map external links open in a new tab [`#1557`](https://github.com/Probable-Futures/apps/pull/1557)
- refactor: Update map control styles on PF Pro to match the ones on PF maps [`#1558`](https://github.com/Probable-Futures/apps/pull/1558)
- fix: Map global view [`#1559`](https://github.com/Probable-Futures/apps/pull/1559)
- build(deps): bump min-document from 2.19.0 to 2.19.2 [`#1554`](https://github.com/Probable-Futures/apps/pull/1554)
- build(deps): bump validator from 13.15.20 to 13.15.23 [`#1555`](https://github.com/Probable-Futures/apps/pull/1555)
- chore: use newer docker compose [`#1553`](https://github.com/Probable-Futures/apps/pull/1553)
- build(deps): bump node-forge from 1.3.1 to 1.3.2 [`#1551`](https://github.com/Probable-Futures/apps/pull/1551)
- fix: dataset rename update [`#1550`](https://github.com/Probable-Futures/apps/pull/1550)
- Hotfix pf pro embeddable map export [`#1548`](https://github.com/Probable-Futures/apps/pull/1548)
- feat: add all experimental statistics DB views [`#1547`](https://github.com/Probable-Futures/apps/pull/1547)
- build(deps): bump validator from 13.11.0 to 13.15.20 [`#1545`](https://github.com/Probable-Futures/apps/pull/1545)
- feat: add mean and median columns [`#1544`](https://github.com/Probable-Futures/apps/pull/1544)
- fix: broken image export [`#1543`](https://github.com/Probable-Futures/apps/pull/1543)
- feat: upgrade kepler [`#1307`](https://github.com/Probable-Futures/apps/pull/1307)
- fix: no space left on git push workflow [`#1542`](https://github.com/Probable-Futures/apps/pull/1542)
- fix: no space left on device error [`#1541`](https://github.com/Probable-Futures/apps/pull/1541)
- fix: uppy issues when uploading an image after creating a project [`#1538`](https://github.com/Probable-Futures/apps/pull/1538)
- fix: Shared Map bugs [`#1537`](https://github.com/Probable-Futures/apps/pull/1537)
- docs: update db readme file [`#1536`](https://github.com/Probable-Futures/apps/pull/1536)
- build(deps): bump tar-fs from 2.1.3 to 2.1.4 [`#1535`](https://github.com/Probable-Futures/apps/pull/1535)
- chore: bump vulnerable deps [`#1534`](https://github.com/Probable-Futures/apps/pull/1534)
- chore: Update all minor and patch package updates [`#1533`](https://github.com/Probable-Futures/apps/pull/1533)
- chore: bump node [`#1531`](https://github.com/Probable-Futures/apps/pull/1531)
- fix: wait a little bit to make sure the dataset selector dropdown has fully closed [`#1530`](https://github.com/Probable-Futures/apps/pull/1530)
- sc-5832: take a screenshot scrollbars appears in dataset selector [`#1529`](https://github.com/Probable-Futures/apps/pull/1529)
- fix: typo in the automated email [`#1528`](https://github.com/Probable-Futures/apps/pull/1528)
- sc-5810: update pf pro onboarding content [`#1525`](https://github.com/Probable-Futures/apps/pull/1525)
- fix: close about map modal on overlay click [`#1524`](https://github.com/Probable-Futures/apps/pull/1524)
- fix: focus fight between modal and inspector [`#1523`](https://github.com/Probable-Futures/apps/pull/1523)
- Feat: maps UI enhancements [`#1522`](https://github.com/Probable-Futures/apps/pull/1522)
- Release 6.0.0 [`b463cbb`](https://github.com/Probable-Futures/apps/commit/b463cbbba7c62153cda11998adba15fd4cdb9c40)
- release 5.0.0 [`dcd6d4d`](https://github.com/Probable-Futures/apps/commit/dcd6d4d266b111ab9f2ffc1d8920a9e7fa0a5bab)
- bot(feat): update submodules [`4e2f348`](https://github.com/Probable-Futures/apps/commit/4e2f348fed8fe5e2bd1cf21a26e5f78de51124f8)
...
- Release 5.0.0 [`c69169f`](https://github.com/Probable-Futures/apps/commit/c69169f118d23ed2c9657851a01ee57bbff0de4a)
...
- feat: update degrees labels [`#1490`](https://github.com/Probable-Futures/apps/pull/1490)
...
- feat: add logs for debugging [`e26a56f`](https://github.com/Probable-Futures/apps/commit/e26a56f391288b1093132a28c0491324e573ac68)
...
- sc-5561: add changelogs to probable futures maps [`#1434`](https://github.com/Probable-Futures/apps/pull/1434)
...
#### [4.12.0](https://github.com/Probable-Futures/apps/compare/4.11.4...4.12.0)
...
#### [v1.1.0](https://github.com/Probable-Futures/apps/compare/v1.0.10...v1.1.0)
...
- chore: downgrade eslint [`085be64`](https://github.com/Probable-Futures/apps/commit/085be648df5e6a7fcc690aaf5213aa876e4a9604)
- fix: test failing esm modules [`ea42c9c`](https://github.com/Probable-Futures/apps/commit/ea42c9c7aa0934953f2b0dc9e5d81e448aa05e61)

#### [v1.0.10](https://github.com/Probable-Futures/apps/compare/v1.0.6...v1.0.10)
