...
export const emailStartOfTheList = `Here are the resources:
  <ol>`;

export const customizableMapsPart = `<li>
  Maps API and customizable climate maps. If you would like to create custom climate maps, you have a few options. Learn more in the <a href="https://docs.probablefutures.org/maps/">Use the maps</a> section of our docs.
</li>`;
